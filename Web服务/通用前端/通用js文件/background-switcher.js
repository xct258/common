...
;(function(){
  ...
  s.textContent=
    ...
    'html:not(.bg-switcher-page-revealed) body{overflow:hidden!important;position:fixed!important;width:100%!important;overscroll-behavior:none}';
  ...
  function injectStyle() {
    ...
    s.textContent =
      ...
      '.__ag_card{' +
        ...
        'transition:width .3s ease,max-width .3s ease,border-radius .3s ease,transform .25s ease;' +
      '}' +

      '.__ag_viewport{' +
        'transition:align-items .25s ease,padding-top .25s ease;' +
      '}' +

      '.__ag_card.__ag_card_compact{' +
        'transform:scale(.85);border-radius:14px;' +
      ...
      '.__ag_header{' +
        ...
        'transition:max-height .35s ease,padding .35s ease,opacity .25s ease;overflow:hidden;' +
      '}' +
      '.__ag_header svg{width:38px;height:38px;margin-bottom:.4rem;opacity:.9;}' +
      '.__ag_header h2{margin:0;font-size:1.2rem;color:var(--bg-image-text-color,#fff);font-weight:600;letter-spacing:.3px;}' +
      '.__ag_header p{margin:.2rem 0 0;font-size:.75rem;color:var(--bg-image-text-color,#fff);opacity:.7;}' +

      '.__ag_body{padding:1.3rem 1.8rem 1.5rem;transition:padding .35s ease;}' +
    ...
    overlay.innerHTML =
      ...
      '<div class="__ag_card" id="__ag_card">' +
        ...
        '<div class="__ag_body">' +
          ...
          '<form id="__ag_form" onsubmit="return false">' +
            '<div class="__ag_fields">' +
              '<div class="__ag_field">' +
                ...
                '<div class="__ag_input_wrap">' +
                  ...
                  '<input id="__ag_u" name="username" type="text" autocomplete="username" placeholder="请输入用户名" />' +
              ...
              '<div class="__ag_field">' +
                ...
                '<div class="__ag_input_wrap">' +
                  ...
                  '<input id="__ag_p" name="password" type="password" autocomplete="current-password" placeholder="请输入密码" />' +
                '</div>' +
              '</div>' +
            '</div>' +
...
var form   = document.getElementById('__ag_form');
    ...
    function adjustForKeyboard() {
      ...
      _adjustTimer = requestAnimationFrame(function () {
        ...
        var availableHeight = viewportHeight - keyboardHeight;
        var needsAdjust = isInputFocused && keyboardHeight > 0 && cardRect.bottom > availableHeight;

        viewport.classList.toggle('__ag_keyboard_up', needsAdjust);
        card.classList.toggle('__ag_card_compact', needsAdjust);
        _adjustTimer = null;
      });
    }
